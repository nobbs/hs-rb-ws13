...
Für diesen Abschnitt sei nun $a$ eine koerzive, parametrisch affine, symmetrische, stetige Bilinearform und $f$ ein parametrisch affines stetiges lineares Funktional.
...
\begin{Definition}
    ...
    Für den Fehler $e(\mu)$ in der $X$-Norm beziehungsweise in der $\mu$-Norm (oder auch Energienorm) setzen wir
    \begin{equation}
...
\begin{Satz}
    ...
    \begin{Beweis}
        ...
        \end{equation}
        folgen die Abschätzung von $\Delta^s_N$ aus dem Beweis für die $\Delta^\text{en}_N$.
    \end{Beweis}
\end{Satz}
...
\begin{Korollar}
    ...
    für alle $\mu \in \mathcal D$.
\end{Korollar}
Man sieht leicht ein, dass es für unsere Anwendungszwecke wünschenswert ist, wenn die Effektivitäten sehr nahe der Eins liegen; unsere Fehlerschätzer die tatsächlichen Fehler also nur minimal überschätzen.
