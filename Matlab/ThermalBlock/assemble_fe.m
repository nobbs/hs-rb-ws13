%% assemble_fe:
%% Assembliert die FE-Steifigkeitsmatrix.
%%
...
function [Ak, F, B, Ud] =  assemble_fe(P, E, T, bx, by)
    ...
    for i = 1:size(T, 2)
        ...
        [Sk, fk] = assemble_fe_element([P(:, T(1, i)), P(:, T(2, i)), P(:, T(3, i))]);
...
%% assemble_fe_element: Berechnet die Elementsteifigkeitsmatrix zum Dreieck C.
function [Sk, fk] = assemble_fe_element(C)
